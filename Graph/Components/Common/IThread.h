...
public:
  ...
  {
    TThread::NameThreadForDebugging(AnsiString(Name.c_str()), ThreadID);
  }
...
void CallFromThread(TMethod Method, const TArg &Arg, TMethod2 Method2)
{
  ...
  public:
    ...
    {
      bool value = true;
      FreeOnTerminate = value; //We need to assign a variable instead of true because of bug in clang
      if(Method2)
