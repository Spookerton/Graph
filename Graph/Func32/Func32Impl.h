...
class TFuncData
{
  ...
  static EParseError HandleParseError(const EParseError &E, const wchar_t* Where, unsigned Pos);
...
public:
  ...
  void Parse(const std::wstring &Str, const TArgType &Args, const TSymbolList *SymbolList, EParseError &E);
