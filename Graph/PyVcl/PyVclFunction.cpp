...
static const TFunctionEntry FunctionList[] =
{
  ...
  {L"KeyDataToShiftState", KeyDataToShiftState, __delphirtti(TShiftState), __delphirtti(int)},
  {L"ShortCut", ShortCut, __delphirtti(TShortCut), __delphirtti(Word), __delphirtti(TShiftState)},
#endif
  ...
  {L"ShowMessage", (void __fastcall (*)(String))ShowMessage, NULL, __delphirtti(String)},
